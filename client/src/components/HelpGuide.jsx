...
const ADMIN_ARTICLES = [
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: 'Reports turns your day-to-day data into trends.' },
      { type: 'list', items: [
        '**Attendance** — presence trends by batch and student.',
        '**Fees** — collected vs outstanding.',
        '**Lesson activity** — who’s watching and completing.',
      ] },
      { type: 'tip', text: 'On a phone, wide tables switch to easy-to-read cards.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'list', items: [
        ...
        '**Modules** — turn optional features (Assignments, Question Papers) on or off.',
      ] },
...
const PARENT_ARTICLES = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'note', text: 'Payments are recorded by your academy. Pay them as you normally do; this screen reflects what they’ve logged.' },
